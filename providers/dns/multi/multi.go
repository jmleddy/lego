...
func NewDefaultConfig() *Config {
	defaultProviders := []string{"route53", "googledomains"}
	return &Config{
...
// route53 and googledomains providers in sequence. See the
// documentation for those providers for a list of appliciable
